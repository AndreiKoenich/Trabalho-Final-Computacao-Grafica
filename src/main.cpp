...
int main(int argc, char* argv[])
{
    ...
    ObjModel palete("../../data/PalletPlywoodNew_GameReady.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = Matrix_Scale(0.15f, 0.15f, 0.15f);
            PushMatrix(model);
                ...
                PushMatrix(model);
                    model = model * Matrix_Rotate_Y(45.0f);
                    glUniformMatrix4fv(g_model_uniform, 1 , GL_FALSE , glm::value_ptr(model));
        ...
        /* DESENHO BARREIRA */
        model = Matrix_Translate(-2.7f, 0.0f, 1.6f) * Matrix_Scale(0.007f, 0.007f, 0.007f) * Matrix_Rotate_X(29.85f);
        glUniformMatrix4fv(g_model_uniform, 1 , GL_FALSE , glm::value_ptr(model));
        ...
        DrawVirtualObject("PalletPlywoodNew_GameReady");
